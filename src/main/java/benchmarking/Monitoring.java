...
public class Monitoring {
    ...
    public ComponentPerformance getMonitoringEvent(String jobId, MongoManager mm) {
        String jsonComponentPerformance = mm.pullPerformanceMonitoringJob("jobId", jobId, "selfPerformanceMonitoring");
    ...
    public void addPerformanceResultsAndSave(ComponentPerformance componentPerformance, MongoManager mm) {
        Thread writeResults = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                mm.updateJsonFromCollectionWithId(componentPerformance.getJobId(),
                        JsonConverter.objectToJsonString(componentPerformance), "selfPerformanceMonitoring");
            }
        });
        writeResults.start();
    }
